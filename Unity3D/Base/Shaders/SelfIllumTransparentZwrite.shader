...
Shader "A Rat King/SelfIllumTransparentZwrite" {
	...
	SubShader {
		...
		Pass {
			...
			float4 _MainTex_ST;
			v2f vert (f2v v) { v2f o; o.pos = UnityObjectToClipPos (v.vertex); o.projPos = ComputeScreenPos(o.pos); COMPUTE_EYEDEPTH(o.projPos.z); o.uv = TRANSFORM_TEX(v.texcoord, _MainTex); return o; }
